...
## UA Ruhr Data Management Plan Catalog   
The "Data Management Plan" question catalog of the UA RUHR adapts certain parts and tasks in the vanilla RDMO catalog `questions/questions-rdmo.xml`  and  `/domain/attributes.xml` [upstream](https://github.com/rdmorganiser/rdmo-catalog). 


## DFG Checklist

This question catalog is based on the checklist [Handling of research Data](https://www.dfg.de/resource/blob/174736/forschungsdaten-checkliste-en.pdf) by the DFG. 
